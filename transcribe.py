...
def convert_to_voice():
    # the model of TTS
    key = '5wvPyDj-BrEoFIi4kgqH1UMlIV0viX_gIRWtRt4K1-Xn'
    url = 'https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/e20a4ba7-4486-4b5b-a612-5f51c3e74a03'
    ...
    with open('./audio.mp3', 'wb') as audio_file:
        res = tts.synthesize(text, accept='audio/mp3', voice='en-us_JamesV3Voice').get_result()
